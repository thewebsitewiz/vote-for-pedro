...
my $fileRoot = '/Users/dennisluken/Dropbox/Projects/WBP/2018/Fraud';

getNameLists();

my @domains = ('gmail.com','yahoo.com','outlook.com','optimum.net','lycos.com','hushmail.com','mail.com');
my @zips = qw[07416 07418 07419 07422 07428 07439 07460 07461 07462 07821 07822 07826 07827 07837 07839 07843 07848 07851 07855 07860 07871 07874 07875 07877 07879 07881 07890];

unlink "$fileRoot/list.csv";
open my $OUT, '>>', "$fileRoot/list.csv";
print $OUT "Email,First Name,Last Name,Phone,ZipCode\n";
...
foreach my $i (1 .. 10000) {
  ...
  my $prefix = 200 + int(rand(999 - 200));
  my $number = 1000 + int(rand(9999 - 1000));

  my $phoneNumber = "$areaCode-$prefix-$number";

  print $OUT "$email,$firstName,$lastName,$phoneNumber,$zip\n";
}
