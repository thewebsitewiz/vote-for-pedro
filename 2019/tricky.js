...
(async () => {
    try {
        ...
        /*
                ...
                categorySelected = 'Best Art Classes';
                votingFor = 'Main Street Gallery';
        ...
        for (let targetCategory of targetCategories) {
            ...
            console.log('category: ', category[1], categorySelected);
        ...
        for (let entrant of entrants) {
            ...
            console.log('entrant: ', oHtmlEntrant);
        ...
        fs.writeFileSync(path.join(__dirname, 'current.html'), registerFormHTML);
        process.exit(0);
