...
const votingFor = 'Will Blochinger Photography';
...
(async () => {
    try {
        console.log('getting new IP address')
        IPAddress = getFreshIP();
...
function getFreshIP() {
    ...
    console.log('returning new IP address: ', currentIp)
